...
4. 运行 install_request.py 以安装依赖。
5. 运行 start_gui 文件启动程序。
6. 找到批量运行窗口，点击“预处理”，点击“一键批量运行”，等待程序完成后完成预处理。
7. 点击“PDF分类工具”，手动完成分类，其中有两个版本可自行选择。
8. 完成分类后，再次找到批量运行窗口。点击“汇总表格处理”，点击“一键批量运行”后生成汇总表格。
